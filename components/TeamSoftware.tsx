...
const teamMembers = [
  {
    name: "Balakrishnan",
    qualifications: "CA | Tax Specialist",
    role: "Australian Tax & Compliance",
  ...
  {
    name: "Vishnu Vijay",
    qualifications: "Senior Business Advisor AUS",
    role: "Strategic & Financial Advisory",
  ...
  {
    name: "Subash",
    qualifications: "BAS Specialist",
    role: "GST & Compliance",
    color: "bg-cyan-100 text-cyan-600"
  },
  {
    name: "Krishna Kumar",
    qualifications: "Advisory Manager",
    role: "Business & Financial Advisory",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            ...
            <div className="text-lg text-slate-300 leading-relaxed mb-8 space-y-4">
              <p>
                Supported by Senior Accountants and Accountants with strong experience and professional qualifications, including semi-qualified and qualified Chartered Accountants (CA) and Cost and Management Accountants (CMA).
              </p>
              <p>
            ...
            <div className="grid grid-cols-2 gap-4">
               ...
               <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                 <div className="text-2xl font-bold text-primary-400 mb-1">Industry Expertise</div>
                 <div className="text-sm text-slate-400">Trusted Senior Professionals</div>
               </div>
            </div>
          </motion.div>
            ...
            {teamMembers.map((member, idx) => (
              ...
              >
                ...
                <p className={`text-[11px] font-bold uppercase tracking-wide ${member.color.split(' ')[1].replace('600', '500')}`}>
                  {member.role.split('\n').map((line, i) => (
                    <span key={i}>{line}{i < member.role.split('\n').length - 1 && <br />}</span>
                  ))}
                </p>
              </motion.div>
            ))}
